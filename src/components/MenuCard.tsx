  ...
  return (
    ...
    >
      <div className="absolute w-full h-full bg-black bg-opacity-50 rounded-xl text-white glow-border ">
        ...
        <p className="bg-transparent px-2 font-lek font-bold">{description}</p>
        <button
          type="button"
          className="border-white font-bold font-lek bs-color mx-2 p-2 absolute bottom-4 rounded-lg"
        >
          {buttonText}
        </button>
      </div>
